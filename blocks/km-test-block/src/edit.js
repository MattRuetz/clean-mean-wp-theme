...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__("Tab Settings", "km-test-block")}>
					{tabs.map((tab) => (
							...
							<MediaUploadCheck>
								<MediaUpload
									...
									render={({ open }) => (
										...
										>
											{tab.imageUrl
												? __("Replace Image", "km-test-block")
												: __("Add Image", "km-test-block")}
										</Button>
									)}
								/>
							</MediaUploadCheck>
									...
									{tabs.map((tab) => (
										...
										>
											<RichText
												...
												placeholder={__("Tab title...", "km-test-block")}
											/>
										</li>
									))}
								</ul>
								...
								{tabs.map((tab) => (
									...
									>
										<RichText
											...
											placeholder={__("Tab heading...", "km-test-block")}
										/>
										<RichText
											tagName="p"
											value={tab.content}
											...
											placeholder={__("Tab content...", "km-test-block")}
										/>
